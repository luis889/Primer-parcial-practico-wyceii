...
<div class="container">
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="start carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="../img/117.jpg" alt="Flower" width="460" height="345">
      </div>
        ...
        <div class="well">
            <div id="myCarousel1" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item">
                        <div class="row">
                            <div class="col-xs-3"><a href="#"><img src="http://placehold.it/500x500" alt="Image" class="img-responsive"></a>
                    ...
                    <div class="item active">
                        <div class="row">
                            <div class="col-xs-3"><a href="#"><img src="http://placehold.it/250x250" alt="Image" class="img-responsive"></a>
